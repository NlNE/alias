...
library.theme = {
    ...
    titlesize = 18,
    font = Enum.Font.Code,
    background = "rbxassetid://1872064795",
    tilesize = 90,
    cursor = false,
    cursorimg = "https://t0.rbxcdn.com/42f66da98c40252ee151326a82aab51f",
    backgroundcolor = Color3.fromRGB(27, 117, 26),
    tabstextcolor = Color3.fromRGB(50, 168, 82),
    bordercolor = Color3.fromRGB(50, 168, 82),
    accentcolor = Color3.fromRGB(29, 82, 43),
    accentcolor2 = Color3.fromRGB(56, 171, 87),
    outlinecolor = Color3.fromRGB(56, 207, 96),
    outlinecolor2 = Color3.fromRGB(255, 255, 255),
    sectorcolor = Color3.fromRGB(30, 30, 30),
    toptextcolor = Color3.fromRGB(255, 255, 255),
    topheight = 48,
    topcolor = Color3.fromRGB(171, 171, 171),
